    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto text-center">
          Our club delves into the depths of mathematics, providing unmatched
          attention to detail and fostering a community that thrives on solving
          complex problems and pushing the boundaries of knowledge.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left mt-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className={cn(
                "group bg-gray-800/80 border border-gray-700/80 p-8 rounded-lg hover:border-primary transition-colors duration-300",
                feature.className,
              )}
            >
