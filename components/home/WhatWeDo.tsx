      ...
      <div className="max-w-6xl mx-auto">
        <h2
          className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-center
                  text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400 py-4"
        >
          Our Objectives
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
          {objectives.map((objective, index) => (
            <Card
              key={index}
              className="bg-gray-900/50 border-purple-500/50 rounded-lg
                          shadow-lg p-6 text-center transition-all duration-300 hover:shadow-purple-500/50
