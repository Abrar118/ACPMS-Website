...
export default function MagazinePage() {
    ...
    // Magazine card component to avoid duplication
    function MagazineCard({ magazine, isFeatured = false }: { magazine: typeof magazines[0]; isFeatured?: boolean }) {
        return (
            <GlassCard
                glow={isFeatured || magazine.featured}
                className={`overflow-hidden group ${isFeatured ? 'border-primary/30' : ''}`}
            >
                    ...
                    <div className="aspect-[3/4] relative overflow-hidden rounded-t-2xl">
                        ...
                        <div className="absolute top-4 right-4">
                            {magazine.featured && (
                                <Badge
                                    variant="default"
                                    className="bg-yellow-500/90 text-yellow-50 backdrop-blur-sm"
                                >
                        ...
                        {magazine.topics.map(
                            (topic: string, index: number) => (
                                <Badge
                                    key={index}
                                    variant="secondary"
                                    className="text-xs whitespace-nowrap bg-white/[0.04] border border-white/[0.08] text-muted-foreground"
                                >
                                    {topic}
                                </Badge>
                            )
    ...
    return (
        <main className="min-h-screen">
            ...
            <section className="py-24 px-4 relative">
                ...
                <div className="max-w-7xl mx-auto text-center relative">
                    ...
                    <SectionHeader
                        ...
                        subtitle="Explore our collection of magazines, each filled with fascinating mathematical insights, puzzles, and articles. Dive into the world of numbers and discover the beauty of mathematics."
                    />
            ...
            {/* Filter Section */}
            <section className="py-8 px-4 border-b border-white/[0.08]">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        ...
                        <Select value={selectedYear} onValueChange={setSelectedYear}>
                            <SelectTrigger className="w-32 bg-white/[0.03] border-white/[0.08] text-foreground">
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        <div className="flex items-center justify-between mb-8">
                            <TabsList className="bg-transparent border-0 p-0 gap-2">
                                <TabsTrigger
                                    value="all"
                                    className="bg-white/[0.04] border border-white/[0.08] text-muted-foreground rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary"
                                >
                                    All Issues
                                </TabsTrigger>
                                <TabsTrigger
                        ...
                        <TabsContent value="all" className="space-y-8">
                            {paginatedMagazines.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-lg font-semibold text-foreground mb-2">No magazines found</h3>
                        ...
                        <TabsContent value="featured" className="space-y-8">
                            ...
                            {featuredMagazines.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-lg font-semibold text-foreground mb-2">No featured magazines found</h3>
                                    <p className="text-muted-foreground">
